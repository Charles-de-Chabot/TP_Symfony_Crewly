 ...
 */
final class Version20260206132152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rental (id INT AUTO_INCREMENT NOT NULL, rental_start DATETIME NOT NULL, rental_end DATETIME NOT NULL, rental_price INT NOT NULL, user_id INT DEFAULT NULL, formula_id INT DEFAULT NULL, boat_id INT DEFAULT NULL, INDEX IDX_1619C27DA76ED395 (user_id), INDEX IDX_1619C27DA50A6386 (formula_id), INDEX IDX_1619C27DA1E84A29 (boat_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('ALTER TABLE rental ADD CONSTRAINT FK_1619C27DA50A6386 FOREIGN KEY (formula_id) REFERENCES formula (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rental DROP FOREIGN KEY FK_1619C27DA50A6386');
